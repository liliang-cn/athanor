...
// door. It depends on both and neither depends on it — the same direction
// alchemy/connectors already runs, and the only one that does not make a cycle.
module github.com/liliang-cn/athanor

go 1.25.0

require (
	github.com/joho/godotenv v1.5.1
	github.com/liliang-cn/alchemy v0.6.8
	github.com/liliang-cn/alchemy/connectors v0.6.8
	github.com/liliang-cn/cortexdb/v2 v2.109.0
